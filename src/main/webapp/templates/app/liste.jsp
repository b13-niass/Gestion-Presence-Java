        ...
        <div class="dropdown-b" style="margin-right: 5%">
            ...
            <div class="dropdown-content-b">
                <form action="" method="POST" id="formRef">
                    ...
                    <label for="idRef"> <input id="idRef" class="check-ref"
                                               type="checkbox" name="referentiels[]"
    ...
    <div class="content">
        ...
        <div class=" tableau">
            ...
            <div class="tableau-body">
                ...
                <div class="row">
                    <div class="col">
                        <img src="/projet/public/icons/" width="23%" alt="" srcset=""/>
                    </div>
                    <div class="col">ssss</div>
                    <div class="col">sss</div>
                    <div class="col">sss</div>
                    <div class="col">ssss</div>
                    <div class="col">sssss</div>
                    <div class="col action-btn" style="display: flex;flex-direction: column;row-gap:2px;">
                        <a href="#carte-modal"
                           style="text-decoration: none;background-color:#009186;color:white;padding: 0 18px;border-radius:3px;">Carte</a>
                        <a href="#nouvelle-1"
                           style="text-decoration: none;background-color:black;color:white;padding: 0 10px;border-radius:3px;">Modifier</a>
                    </div>
                </div>
            </div>
...
<div id="insertion-masse" class="overlay1">
    ...
    <div class="popup">
        ...
        <form action="/rapport-import" method="post" enctype="multipart/form-data">
            ...
            <button style="visibility: hidden;" id="btnSubmitInsMass" type="submit" name="enregistrer_app">Enregistrer
            </button>
        </form>
        <div>
                ...
                <tr>
                    ...
                    <td style="padding: 0.3%">
                        <form action="" method="POST" style="width:100%;height: 35px;">
                            ...
                            <button type="submit" name="resend-mail"
                                    style="width:100%;height:80%;border:none;background-color:#009186;color:white;">
                                Renvoyer
                            </button>
                        </form>
                    </td>
